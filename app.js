...
function init() {
    ...
    sizeGridSlider = document.getElementById('sizeGridSlider');
    ...
    sizeGridSlider.min = 10;
    sizeGridSlider.max = 50;
    sizeGridSlider.step = 10;
    sizeGridSlider.value = PIXEL_SIZE;
    sizeGridSlider.onchange = function() {
